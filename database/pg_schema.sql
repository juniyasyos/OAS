...
--
-- Name: breezy_sessions; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.breezy_sessions OWNER TO postgres;

--
-- Name: breezy_sessions_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER SEQUENCE public.breezy_sessions_id_seq OWNER TO postgres;

--
-- Name: breezy_sessions_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: socialite_users; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.socialite_users OWNER TO postgres;

--
-- Name: socialite_users_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER SEQUENCE public.socialite_users_id_seq OWNER TO postgres;

--
-- Name: socialite_users_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: breezy_sessions id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Name: socialite_users id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Name: breezy_sessions breezy_sessions_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: settings settings_group_name_unique; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: socialite_users socialite_users_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: socialite_users socialite_users_provider_provider_id_unique; Type: CONSTRAINT; Schema: public; Owner: postgres
--
